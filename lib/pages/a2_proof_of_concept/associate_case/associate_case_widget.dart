                          ...
                          child: Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                ...
                                validator: _model
                                    .caseNameInputTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.caseDescriptionInputTextController,
                          ...
                          return FlutterFlowDropDown<String>(
                            ...
                            options: List<String>.from((getJsonField(
                              ...
                              true,
                                ...
                                .toList()),
                            optionLabels: SupabaseIntegrationGroup
                                .getAllCasesCall
                                .caseNames(
                              casesListGetAllCasesResponse.jsonBody,
                            )!,
                    ...
                    builder: (context) {
                      return Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            _model.apiResultcon =
                                await SupabaseIntegrationGroup
                                    .associateCaseWithConversationCall
                                    .call(
                              caseId: FFAppState()
                                  .CaseIdToAssociationStateVariable,
                              conversationId:
                                  FFAppState().ConversationIdStateVariable,
                            );
