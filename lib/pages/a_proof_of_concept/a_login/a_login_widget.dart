...
class _ALoginWidgetState extends State<ALoginWidget> {
  ...
  void initState() {
    ...
    _model.clientIdTextFieldTextController ??= TextEditingController();
    _model.clientIdTextFieldFocusNode ??= FocusNode();
                ...
                child: Align(
                  ...
                  child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      validator: _model.userTextFieldTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
              ...
              Flexible(
                child: Align(
                  ...
                  child: SizedBox(
                    width: 200.0,
                    child: TextFormField(
                      controller: _model.clientIdTextFieldTextController,
                      focusNode: _model.clientIdTextFieldFocusNode,
                      autofocus: false,
                      obscureText: false,
                      decoration: InputDecoration(
                        isDense: true,
                      ...
                      cursorColor: FlutterFlowTheme.of(context).primaryText,
                      validator: _model.clientIdTextFieldTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
              ...
              Flexible(
                child: Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      _model.salesBoToken = await SalesBoAuthCall.call(
                        user: _model.userTextFieldTextController.text,
                        password: _model.passwordTextFieldTextController.text,
                        clientId: _model.clientIdTextFieldTextController.text,
                      );

                      if ((_model.salesBoToken?.succeeded ?? true)) {
                        FFAppState().AuthTokenStateVariable =
                            SalesBoAuthCall.accessToken(
                          (_model.salesBoToken?.jsonBody ?? ''),
                        )!;
                        safeSetState(() {});

                        context.pushNamed('B_CreateLead');
                      } else {
