    ...
    final ffApiRequestBody = '''
{
  ...
  "clientId": "${escapeStringForJson(clientId)}"
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'SalesAuth',
      apiUrl: 'https://api-stg.ituran.com.br/sales/Authentication/Token',
...
class GetVehicleBrandsCall {
  static Future<ApiCallResponse> call() async {
    return ApiManager.instance.makeApiCall(
      callName: 'Get Vehicle Brands',
      apiUrl: 'http://api-stg.ituran.com.br/sales/vehicle/brands',
  ...
  static List<String>? vehicleBrands(dynamic response) => (getJsonField(
        response,
        r'''$.Data[:].NM_MARCA''',
        true,
      ) as List?)
