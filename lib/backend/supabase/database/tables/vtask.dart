...
class VtaskTable extends SupabaseTable<VtaskRow> {
  @override
  String get tableName => 'vtask';

  @override
  VtaskRow createRow(Map<String, dynamic> data) => VtaskRow(data);
}

class VtaskRow extends SupabaseDataRow {
  VtaskRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VtaskTable();
